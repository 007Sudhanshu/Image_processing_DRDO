...
img= '12.jpg'
prototxt = 'S:/Courses and internships/Image_processing1/New/MobileNetSSD_deploy.prototxt'
model= 'S:/Courses and internships/Image_processing1/New/MobileNetSSD_deploy.caffemodel'
min_confidence= 0.2
...
cv2.imshow("Oject Detection", img)
cv2.waitKey(0)
